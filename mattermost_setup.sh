...
# Download Mattermost
if [ ! -f /vagrant/mattermost-5.12.1-linux.amd64.tar.gz ]; then
    wget --quiet https://releases.mattermost.com/5.12.1/mattermost-5.12.1-linux-amd64.tar.gz
    cp mattermost-5.12.1-linux-amd64.tar.gz /vagrant/mattermost-5.12.1-linux.amd64.tar.gz
else
	cp /vagrant/mattermost-5.12.1-linux.amd64.tar.gz ./	
fi
